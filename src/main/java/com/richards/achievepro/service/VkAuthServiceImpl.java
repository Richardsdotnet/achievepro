...
public class VkAuthServiceImpl  implements VkAuthInterface {





        private static final Logger logger = LoggerFactory.getLogger(VkAuthServiceImpl.class);
        ...
        public String getAuthenticatedUserId(String launchParams) {
            ...
            if (!expectedSign.equals(sign)) {
                ...
                logger.error("Check String:  {}", checkString);
                logger.error("Expected Sign: {}", expectedSign);
                logger.error("Received Sign: {}", sign);
                logger.error("-----------------------");
